...
Se va a aplicar un clustering jerárquico con varios números de cluster y se van a visualizar los resultados con dendrogramas.
```{r}
...
rect.hclust(modelo, k = 2, border = "magenta")
```
