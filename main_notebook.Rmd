...
# creamos una variable que cuenta para cada job el número de clientes del dataset que tienen esa edad
...
pie(x=job$n, labels = job$`df_train$job`, radius = 1, main = "Número de clientes en función del job", col = viridis(length(x)))
  

# ggplot(job, aes(x = `df_train$job` ,y = job$n)) +
#  ggtitle("Número de clientes en función del job") +
#  labs(x="job", y = "número de clientes") +
