...
De nuevo se puede puede observar que los datos representan bien cada categoría de la población porque hay muchos cientes para cada categoría.
...
Para terminar, se van a aplicar varios algoritmos de clustering para ver si el conjunto de clientes se puede dividir en varios subconjuntos con clientes que se aparecen, y comparar los resultados de estos algoritmos de clustering.
